  ...
  return (
    <section id="projects" className="py-20 lg:py-32 bg-[#F7F7F5] dark:bg-[#242936] transition-colors duration-300">
      <div className="reveal-section max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="reveal-item card-hover bg-white dark:bg-[#1A1F2E] rounded-2xl shadow-xl overflow-hidden border-2 border-[#D3A96F]/20 transition-colors duration-300">
          <div className="p-8 lg:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="flex items-start gap-3 bg-[#F7F7F5] dark:bg-[#242936] p-5 rounded-lg border border-[#D3A96F]/20 transition-colors duration-300">
                <Users size={24} className="text-[#D3A96F] flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-[#0E1A2B] dark:text-[#E8E9ED] mb-1">Sponsorship Success</h4>
              ...
              <div className="flex items-start gap-3 bg-[#F7F7F5] dark:bg-[#242936] p-5 rounded-lg border border-[#D3A96F]/20 transition-colors duration-300">
                ...
                <div>
                  <h4 className="font-semibold text-[#0E1A2B] dark:text-[#E8E9ED] mb-1">Strategic Management</h4>
                  <p className="text-[#D3A96F]">
              ...
              <div className="flex items-start gap-3 bg-[#F7F7F5] dark:bg-[#242936] p-5 rounded-lg border border-[#D3A96F]/20 transition-colors duration-300">
                ...
                <div>
                  <h4 className="font-semibold text-[#0E1A2B] dark:text-[#E8E9ED] mb-1">National Recognition</h4>
                  <p className="text-[#D3A96F]">
              ...
              <div className="flex items-start gap-3 bg-[#F7F7F5] dark:bg-[#242936] p-5 rounded-lg border border-[#D3A96F]/20 transition-colors duration-300">
                ...
                <div>
                  <h4 className="font-semibold text-[#0E1A2B] dark:text-[#E8E9ED] mb-1">Skills Developed</h4>
                  <p className="text-[#D3A96F]">
